 ...
 *
 * Quad tree. original from
 * https://algs4.cs.princeton.edu/92search/QuadTree.java
 ******************************************************************************/
...
public class QuadTree<Key extends Comparable<Key>, Value> {
	...
	public static void main(String[] args) {
		int M = 5;// Integer.parseInt(args[0]); // queries
		int N = 5;// Integer.parseInt(args[1]); // points
